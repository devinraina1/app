...
import com.yehiaelsayed.myins.AccountSettingsActivity;
import com.yehiaelsayed.myins.Adapters.MyPostsAdapter;
...
import com.yehiaelsayed.myins.SignInActivity;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (!TextUtils.isEmpty(user.getBio())){
                        Bio.setText("Bingo user");
                    } else {Bio.setText("Bingo User");}
        ...
        UserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    FullName.setText(user.getFullname());
                    if (!TextUtils.isEmpty(user.getBio())){
                        Bio.setText("Hey, I am a bingo user");
